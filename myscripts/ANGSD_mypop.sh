...
# now we are going to do a folded spectrum that flips the minor and major allele frequencies because there are some sites where the reference genome may not have the real ancestral state for the genome

# let's calculate the SFS floor the folded minor allele frequencies
